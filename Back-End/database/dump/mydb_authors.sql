...
CREATE TABLE `authors` (
  ...
  KEY `u_id_idx` (`u_id`),
  CONSTRAINT `FKrj0rc5orrsheh5osxs6q3xee4` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
...
INSERT INTO `authors` VALUES (1,'thanaphat','sigco','thana@hotmail.com',5,NULL);
