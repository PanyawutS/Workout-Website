...
CREATE TABLE `user_programs` (
  ...
  KEY `FKp5evq0h62lr9uv99a6elhfw0a` (`user_id`),
  KEY `FKgrrly3jlq980x4ilci0agy4w8` (`program_id`),
  CONSTRAINT `FKgrrly3jlq980x4ilci0agy4w8` FOREIGN KEY (`program_id`) REFERENCES `workoutprograms` (`program_id`),
  CONSTRAINT `FKp5evq0h62lr9uv99a6elhfw0a` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
